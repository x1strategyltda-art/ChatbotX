DROP TYPE IF EXISTS "fileContextType" CASCADE;--> statement-breakpoint
DROP TYPE IF EXISTS "fileStatus" CASCADE;--> statement-breakpoint
DROP TYPE IF EXISTS "importStatus" CASCADE;--> statement-breakpoint
DROP TYPE IF EXISTS "importType" CASCADE;--> statement-breakpoint
DROP TYPE IF EXISTS "importFormat" CASCADE;--> statement-breakpoint

DROP TABLE IF EXISTS "File" CASCADE;--> statement-breakpoint
DROP TABLE IF EXISTS "Import" CASCADE;--> statement-breakpoint

CREATE TYPE "fileContextType" AS ENUM('import', 'generic');--> statement-breakpoint
...
CREATE TABLE "Import" (
  ...
  "format" "importFormat" NOT NULL DEFAULT 'csv'::"importFormat",
