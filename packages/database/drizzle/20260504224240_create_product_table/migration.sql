...
ALTER TABLE "ProductVariantOption" ADD CONSTRAINT "ProductVariantOption_productId_Product_id_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;